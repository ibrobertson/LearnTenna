...
class NodesCalculator {
    ...
    getDetailedResonanceInfo(model) {
        ...
        const commonResonantLengths = [
            { length: wavelength * 0.25, name: 'λ/4 (Quarter Wave)' },
            { length: wavelength * 0.5, name: 'λ/2 (Half Wave)' },
            { length: wavelength * 0.75, name: '3λ/4 (Three Quarter)' },
            { length: wavelength * 1.0, name: 'λ (Full Wave)' },
            { length: wavelength * 1.5, name: '3λ/2 (One and Half)' }
        ];
